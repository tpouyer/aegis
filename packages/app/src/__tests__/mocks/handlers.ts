...
export const handlers = [
  ...
  http.get(`${jiraBaseUrl}/ex/jira/${cloudId}/rest/agile/1.0/board/:boardId/configuration`, () => {
    return HttpResponse.json(mockBoardConfig)
  }),

  // ── Jira: Issues ─────────────────────────────────────────────────
  http.get(`${jiraBaseUrl}/ex/jira/${cloudId}/rest/agile/1.0/board/:boardId/issue`, () => {
    return HttpResponse.json(mockIssues)
  }),

  http.get(`${jiraBaseUrl}/ex/jira/${cloudId}/rest/api/3/issue/:issueKey`, ({ params }) => {
  ...
  http.post(`${jiraBaseUrl}/ex/jira/${cloudId}/rest/api/3/search`, () => {
    return HttpResponse.json(mockIssues)
  }),

  // ── Jira: Transitions ────────────────────────────────────────────
  http.get(`${jiraBaseUrl}/ex/jira/${cloudId}/rest/api/3/issue/:issueKey/transitions`, () => {
    return HttpResponse.json(mockTransitions)
  }),

  http.post(`${jiraBaseUrl}/ex/jira/${cloudId}/rest/api/3/issue/:issueKey/transitions`, () => {
  ...
  http.patch('https://api.github.com/repos/:owner/:repo/git/refs/:ref', () => {
    return HttpResponse.json(mockRef)
  }),
...
export { mockBoardConfig, mockBoards, mockCommit, mockFileContent, mockIssues, mockRef, mockTransitions, mockTree }
